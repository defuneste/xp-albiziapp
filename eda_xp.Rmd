...
Le système via genre/nom commun/espèce permet d'éviter de mettre juste "faux" pour les platanes. Il faudra cependant bien faire attention dans l'analyse à des effets d'espèces (des espèces plus difficiles, on reproduit tout le temps la même erreur)
