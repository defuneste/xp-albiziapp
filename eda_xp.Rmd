...
Cela correspondait à `r sum(!is.na(xp_bota.shp$verif))` pour `r sum(!is.na(xp_bota.shp$bota))` relevés avec une info botanique (genre, espèce, nom commun). Cela représenta une mâtinée de travail. Dans ces cas la photo fût aussi utilisée et fût d'une aide précieuse.

Après reflexion, j'ai décidé de mettre faux au nom d'espèce des platanes. 
