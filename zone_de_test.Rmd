...
Il y a entre 41 et 42 genres d'arbres (en fonction d'où on range les macromeles). Prés de 50% (cf. figure : \@ref(fig:genrezone)) des arbres se retrouvent être soit des *Platanus* (une seule espèce) soit des *Prunus* (6 espèces). 62 espèces se répartissent dans ces genres. 
