...
print("le nom du fichier de l'expérience du 16/09/2019 est xp_16_09_bota.shp")


## 5 - Export vérification  ================

### stream du json
exp_brut <- stream_in(file("data/history.json"))

# on met la bonne tz 
attr(exp_brut$date, "tzone") <- "Europe/Paris"
### zone de l'xp
...
history_16_09 <- subset(exp_brut, date > ymd_hms("2019-09-15T09:00:00Z", tz = "Europe/Paris"))
...
validateObservation <- history_16_09[history_16_09$event == "validateObservation",]
...
identification <- history_16_09[history_16_09$event == "identification",]
